...
// Create a new pool with minimal connections
...
async function addContractorsAIAnalysis() {
  try {
    ...
    // Insert/Update contractors with AI analysis
    ...
    for (const contractor of contractors) {
      console.log(`Processing ${contractor.company_name}...`);
      await runQuery(`
      ...
      console.log(`✅ ${contractor.company_name}`);
    }
